...
import 'edit_accaunt_page_model.dart';
export 'edit_accaunt_page_model.dart';

class EditAccauntPageWidget extends StatefulWidget {
  const EditAccauntPageWidget({super.key});

  static String routeName = 'EditAccauntPage';
  static String routePath = '/editAccauntPage';

  @override
  State<EditAccauntPageWidget> createState() => _EditAccauntPageWidgetState();
}

class _EditAccauntPageWidgetState extends State<EditAccauntPageWidget> {
  late EditAccauntPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditAccauntPageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.male = valueOrDefault<bool>(currentUserDocument?.male, false);
      _model.female = valueOrDefault<bool>(currentUserDocument?.female, false);
      safeSetState(() {});
    });
    ...
    _model.numberFieldGidTextController ??=
        TextEditingController(text: currentPhoneNumber);
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      20.0, 5.0, 20.0, 0.0),
                                  child: Text(
                                    'Обновите профиль и продолжайте свой путь с нами',
