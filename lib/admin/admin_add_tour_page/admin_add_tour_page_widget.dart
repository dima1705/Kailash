...
import 'admin_add_tour_page_model.dart';
export 'admin_add_tour_page_model.dart';

class AdminAddTourPageWidget extends StatefulWidget {
  const AdminAddTourPageWidget({super.key});

  static String routeName = 'AdminAddTourPage';
  static String routePath = '/adminAddTourPage';

  @override
  State<AdminAddTourPageWidget> createState() => _AdminAddTourPageWidgetState();
}

class _AdminAddTourPageWidgetState extends State<AdminAddTourPageWidget> {
  late AdminAddTourPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminAddTourPageModel());

    _model.tourNameTextController ??= TextEditingController();
    _model.tourNameFocusNode ??= FocusNode();

    _model.tourDescriptionTextController ??= TextEditingController();
    _model.tourDescriptionFocusNode ??= FocusNode();

    _model.tourWeatherTextController ??= TextEditingController();
    _model.tourWeatherFocusNode ??= FocusNode();

    _model.tourDistanceTextController ??= TextEditingController();
                                                ...
                                                onTap: () async {
                                                  ...
                                                  if (selectedMedia != null &&
                                                    ...
                                                    try {
                                                      ...
                                                      _model.isDataUploading_tourImage =
                                                          false;
                                                    }
                                                    if (selectedUploadedFiles
                                                        ...
                                                        downloadUrls.length ==
                                                            selectedMedia
                                                                .length) {
                                                      safeSetState(() {
                                                        _model.uploadedLocalFile_tourImage =
                                                            selectedUploadedFiles
                                                                .first;
                                                        _model.uploadedFileUrl_tourImage =
                                                            downloadUrls.first;
                                                      });
                                                    } else {
                                                      safeSetState(() {});
                                                  ...
                                                  if (_model.uploadedFileUrl_tourImage !=
                                                          null &&
                                                      _model.uploadedFileUrl_tourImage !=
                                                          '') {
                                                    _model.preview = _model
                                                        .uploadedFileUrl_tourImage;
                                                    safeSetState(() {});
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'Добавьте изображение экспедиции',
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: FlutterFlowPlacePicker(
                                              ...
                                              defaultText: 'Локация экспедиции',
                                              icon: Icon(
                                                Icons.place,
                                      ...
                                      child: Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            focusNode:
                                                _model.tourDescriptionFocusNode,
                                            autofocus: false,
                                            enabled: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        enableInteractiveSelection:
                                                                            true,
                                                                        validator: _model
                                                                            .tourWeatherTextControllerValidator
                                                                            .asValidator(context),
                                                                      ),
                                                                    ),
                                                                  ),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      enableInteractiveSelection:
                                                                          true,
                                                                      validator: _model
                                                                          .tourDistanceTextControllerValidator
                                                                          .asValidator(
                                                                              context),
                                                                    ),
                                                                  ),
