...
import 'admin_vebinar_model.dart';
export 'admin_vebinar_model.dart';

class AdminVebinarWidget extends StatefulWidget {
  const AdminVebinarWidget({
    super.key,
  ...
  static String routeName = 'AdminVebinar';
  static String routePath = '/adminVebinar';

  @override
  State<AdminVebinarWidget> createState() => _AdminVebinarWidgetState();
}

class _AdminVebinarWidgetState extends State<AdminVebinarWidget> {
  late AdminVebinarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminVebinarModel());
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  UpdateVebinarWidget.routeName,
                                  queryParameters: {
                                    'vebinar': serializeParam(
                                      widget!.vebinarDocument,
                                      ParamType.Document,
                                    ),
                                  }.withoutNulls,
                                  extra: <String, dynamic>{
                                    'vebinar': widget!.vebinarDocument,
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed(
                              ...
                              extra: <String, dynamic>{
                                'vebinarDocument': widget!.vebinarDocument,
                                kTransitionInfoKey: TransitionInfo(
                                  hasTransition: true,
                                  transitionType: PageTransitionType.fade,
                                ),
