...
import 'admin_tour_model.dart';
export 'admin_tour_model.dart';

class AdminTourWidget extends StatefulWidget {
  const AdminTourWidget({
    super.key,
  ...
  static String routeName = 'AdminTour';
  static String routePath = '/adminTour';

  @override
  State<AdminTourWidget> createState() => _AdminTourWidgetState();
}

class _AdminTourWidgetState extends State<AdminTourWidget> {
  late AdminTourModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminTourModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ChatsRecord>(
      stream: ChatsRecord.getDocument(widget!.tourDocument!.tourChat!),
      builder: (context, snapshot) {
        ...
        final adminTourChatsRecord = snapshot.data!;
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      ...
                                      extra: <String, dynamic>{
                                        'tourDocument': widget!.tourDocument,
                                                      ...
                                                      children: [
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            ...
                                                            FFAppState().removeFromTourApplicationsUsers(
                                                                containerUsersRecord
                                                                    .reference);
                                                            safeSetState(() {});
                                                          },
