...
import 'update_ivent_model.dart';
export 'update_ivent_model.dart';

class UpdateIventWidget extends StatefulWidget {
  const UpdateIventWidget({
    super.key,
    this.iventDocument,
  });
  ...
  static String routeName = 'UpdateIvent';
  static String routePath = '/updateIvent';

  @override
  State<UpdateIventWidget> createState() => _UpdateIventWidgetState();
}

class _UpdateIventWidgetState extends State<UpdateIventWidget> {
  late UpdateIventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateIventModel());

    _model.iventNameTextController ??=
        TextEditingController(text: widget!.iventDocument?.iventTitle);
    _model.iventNameFocusNode ??= FocusNode();

    _model.iventDescriptionTextController ??=
        TextEditingController(text: widget!.iventDocument?.iventDescription);
    _model.iventDescriptionFocusNode ??= FocusNode();

    _model.maxParticipantsTextController ??= TextEditingController(
        text: widget!.iventDocument?.iventMaxParticipants?.toString());
    _model.maxParticipantsFocusNode ??= FocusNode();

    _model.iventPriceTextController ??= TextEditingController(
        text: widget!.iventDocument?.iventPrice?.toString());
    ...
    return StreamBuilder<List<InteractiveRecord>>(
      stream: queryInteractiveRecord(
        queryBuilder: (interactiveRecord) => interactiveRecord.where(
          'isIvent',
          isEqualTo: widget!.iventDocument?.reference,
        ),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<InteractiveRecord> updateIventInteractiveRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final updateIventInteractiveRecord =
            updateIventInteractiveRecordList.isNotEmpty
                ? updateIventInteractiveRecordList.first
                : null;
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                await widget!.iventDocument!.reference.delete();
                                await updateIventInteractiveRecord!.reference
                                    .delete();
                              },
                              child: Container(
                                width: 40.0,
                                                  ...
                                                  builder: (context) => Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_imgIventUPD =
                                                                  true);
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_imgIventUPD =
                                                                  selectedUploadedFiles
                                                                      .first;
                                                              _model.uploadedFileUrl_imgIventUPD =
                                                                  downloadUrls
                                                                      .first;
                                                            });
                                                          } else {
                                                        ...
                                                        if (_model.uploadedFileUrl_imgIventUPD !=
                                                                null &&
                                                            _model.uploadedFileUrl_imgIventUPD !=
                                                                '') {
                                                          FFAppState()
                                                ...
                                                builder: (context) => InkWell(
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    if ((_model.valid ==
                                                      ...
                                                      await updateIventInteractiveRecord!
                                                          .reference
                                                          .update(
                                                              createInteractiveRecordData(
                                                        image: _model.uploadedFileUrl_imgIventUPD !=
                                                                    null &&
                                                                _model.uploadedFileUrl_imgIventUPD !=
                                                                    ''
                                                            ? _model
                                                                .uploadedFileUrl_imgIventUPD
                                                            : updateIventInteractiveRecord
                                                                ?.image,
                                                        title: _model
                                                            .iventNameTextController
                                                            .text,
